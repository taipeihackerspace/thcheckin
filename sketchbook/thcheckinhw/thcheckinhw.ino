/*
 * Taipei Hackerspace Check-in System
 *
 ...
 *
 * RDID code based on RFID.pde by Dr. Leong ( www.b2cqshop.com )
 */
...
#define CHECKIN 1
#define CHECKOUT 2
#define CHECKTIMEOUT 0

// Set pins
const int checkInButton = 3;
const int checkOutButton = 2;

const int checkInLED = 10;
const int checkOutLED = 9;
...
void setup() {
  ...
  pinMode(checkInButton, INPUT);
  pinMode(checkOutButton, INPUT);
...
void fastBlink(int pin, int blinktime, int times) {
